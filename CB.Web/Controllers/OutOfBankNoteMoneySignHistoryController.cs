...
using CB.Application.Validators.OutOfBankNoteMoneySignHistory;
...
namespace CB.Web.Controllers
{
    ...
    [Authorize]
    public class OutOfBankNoteMoneySignHistoryController : ControllerBase
    {
        private readonly IOutOfBankNoteMoneySignHistoryService _moneySignHistoryService;
        private readonly OutOfBankNoteMoneySignHistoryCreateValidator _createValidator;
        private readonly OutOfBankNoteMoneySignHistoryEditValidator _editValidator;

        public OutOfBankNoteMoneySignHistoryController(
            IOutOfBankNoteMoneySignHistoryService moneySignHistoryService,
            OutOfBankNoteMoneySignHistoryCreateValidator createValidator,
            OutOfBankNoteMoneySignHistoryEditValidator editValidator
        )
        {
        ...
        {
            List<OutOfBankNoteMoneySignHistoryGetDTO> data = await _moneySignHistoryService.GetAllAsync();
            return Ok(data);
        }
        ...
        {
            OutOfBankNoteMoneySignHistoryGetDTO? data = await _moneySignHistoryService.GetByIdAsync(id);
            if (data is null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] OutOfBankNoteMoneySignHistoryCreateDTO dTO)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Edit(int id, [FromBody] OutOfBankNoteMoneySignHistoryEditDTO dTO)
        {
