...
using CB.Application.Validators.Address;
...
namespace CB.Web.Controllers
{
    ...
    public class AddressController : ControllerBase
    {
        ...
        private readonly AddressEditValidator _editValidator;

        public AddressController(
            IAddressService addressService,
            AddressCreateValidator createValidator,
            AddressEditValidator editValidator
        )
        {
        ...
        public async Task<IActionResult> Create([FromBody] AddressCreateDTO dto)
        {
            ...
            if (!created)
            {
                Log.Error("Ünvan əlavə edilməsi uğursuz oldu {@Dto}", dto);
        ...
        // PUT: /api/address/{id}
        [HttpPut("{id}")]
        public async Task<IActionResult> Edit(int id, [FromBody] AddressEditDTO dto)
        {
            ...
            if (!updated)
            {
                Log.Error("Ünvan yenilənməsi uğursuz oldu {@Dto}", dto);
                return NotFound();
            }

            Log.Information("Ünvan yenilənməsi uğurludur {@Dto}", dto);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (!deleted)
            {
                Log.Warning("Ünvan silinməsi uğursuz oldu Id={@Id}", id);
                return NotFound();
            }
            Log.Information("Ünvan uğurla silindi : Id={@Id}", id);
