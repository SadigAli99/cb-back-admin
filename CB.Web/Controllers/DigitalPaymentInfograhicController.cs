...
using CB.Application.Validators.DigitalPaymentInfograhic;
...
namespace CB.Web.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DigitalPaymentInfograhicController : ControllerBase
    {
        private readonly IDigitalPaymentInfograhicService _digitalPaymentInfographicService;
        private readonly DigitalPaymentInfograhicCreateValidator _createValidator;
        private readonly DigitalPaymentInfograhicEditValidator _editValidator;

        public DigitalPaymentInfograhicController(
            IDigitalPaymentInfograhicService digitalPaymentInfographicService,
            DigitalPaymentInfograhicCreateValidator createValidator,
            DigitalPaymentInfograhicEditValidator editValidator
        )
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DigitalPaymentInfograhicCreateDTO dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Edit(int id, [FromBody] DigitalPaymentInfograhicEditDTO dto)
        {
