...
using CB.Application.Validators.DigitalPaymentInfograhicItem;
...
namespace CB.Web.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DigitalPaymentInfograhicItemController : ControllerBase
    {
        private readonly IDigitalPaymentInfograhicItemService _digitalPaymentInfographicItemService;
        private readonly DigitalPaymentInfograhicItemCreateValidator _createValidator;
        private readonly DigitalPaymentInfograhicItemEditValidator _editValidator;

        public DigitalPaymentInfograhicItemController(
            IDigitalPaymentInfograhicItemService digitalPaymentInfographicItemService,
            DigitalPaymentInfograhicItemCreateValidator createValidator,
            DigitalPaymentInfograhicItemEditValidator editValidator
        )
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DigitalPaymentInfograhicItemCreateDTO dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Edit(int id, [FromBody] DigitalPaymentInfograhicItemEditDTO dto)
        {
