...
using CB.Application.Validators.DigitalPaymentInfographicCategory;
...
namespace CB.Web.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DigitalPaymentInfographicCategoryController : ControllerBase
    {
        private readonly IDigitalPaymentInfographicCategoryService _digitalPaymentInfographicCategoryService;
        private readonly DigitalPaymentInfographicCategoryCreateValidator _createValidator;
        private readonly DigitalPaymentInfographicCategoryEditValidator _editValidator;

        public DigitalPaymentInfographicCategoryController(
            IDigitalPaymentInfographicCategoryService digitalPaymentInfographicCategoryService,
            DigitalPaymentInfographicCategoryCreateValidator createValidator,
            DigitalPaymentInfographicCategoryEditValidator editValidator
        )
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DigitalPaymentInfographicCategoryCreateDTO dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Edit(int id, [FromBody] DigitalPaymentInfographicCategoryEditDTO dto)
        {
