...
namespace CB.Infrastructure.Services
{
    public class BankInvestmentCaptionService : IBankInvestmentCaptionService
    {
        ...
        public async Task<bool> CreateOrUpdate(BankInvestmentCaptionPostDTO dto)
        {
            ...
            BankInvestmentCaption? about = await _repository.GetQuery()
            ...
            if (about is null)
            {
                about = _mapper.Map<BankInvestmentCaption>(dto);
            ...
            else
            {
                ...
                foreach (var v in dto.Descriptions)
                {
                    ...
                    {
                        about.Translations.Add(new BankInvestmentCaptionTranslation
                        {
                            LanguageId = lang.Id,
                            Description = v.Value
                        });
        ...
        public async Task<BankInvestmentCaptionGetDTO?> GetFirst()
        {
            ...
            return about == null ? null : _mapper.Map<BankInvestmentCaptionGetDTO>(about);
        }
    }
}
