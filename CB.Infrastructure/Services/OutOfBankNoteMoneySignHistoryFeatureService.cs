...
{
    public class OutOfBankNoteMoneySignHistoryFeatureService : IOutOfBankNoteMoneySignHistoryFeatureService
    {
        private readonly IGenericRepository<MoneySignHistoryFeature> _repository;
        private readonly IGenericRepository<Language> _languageRepository;
        private readonly IMapper _mapper;

        public OutOfBankNoteMoneySignHistoryFeatureService(
            IMapper mapper,
        ...
        public async Task<bool> CreateOrUpdate(OutOfBankNoteMoneySignHistoryFeaturePostDTO dto)
        {
            ...
            MoneySignHistoryFeature? entity = await _repository.GetQuery()
                                        ...
                                        .FirstOrDefaultAsync(x => x.MoneySignHistory.MoneySign.Type == MoneySignType.BANKNOTEOUT);
        ...
        public async Task<OutOfBankNoteMoneySignHistoryFeatureGetDTO?> GetFirst()
        {
            MoneySignHistoryFeature? entity = await _repository.GetQuery()
                .Include(h => h.Translations)
            ...
            var data = _mapper.Map<OutOfBankNoteMoneySignHistoryFeatureGetDTO>(entity);
