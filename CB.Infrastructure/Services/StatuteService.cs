...
{
    public class StatuteService : IStatuteService
    {
        ...
        public async Task<List<StatuteGetDTO>> GetAllAsync()
        {
            ...
            List<StatuteGetDTO> data = _mapper.Map<List<StatuteGetDTO>>(entities);
            return data;
        }
        public async Task<StatuteGetDTO?> GetByIdAsync(int id)
        {
            ...
            StatuteGetDTO? data = entity is null ? null : _mapper.Map<StatuteGetDTO>(entity);

            return data;
        }
        public async Task<bool> CreateAsync(StatuteCreateDTO dto)
        {
        ...
        public async Task<bool> UpdateAsync(int id, StatuteEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
