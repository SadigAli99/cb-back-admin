...
namespace CB.Infrastructure.Services
{
    public class AboutService : IAboutService
    {
        ...
        public AboutService(
            IMapper mapper,
            IGenericRepository<About> repository,
        ...
        public async Task<bool> CreateOrUpdate(AboutPostDTO dto)
        {
            var languages = await _languageRepository.GetAllAsync();
            About? entity = await _repository.GetQuery()
            ...
            else
            {
                ...
                foreach (var v in dto.Descriptions)
                {
                    ...
                    {
                        entity.Translations?.Add(new AboutTranslation
                        {
                            LanguageId = lang.Id,
                            Description = v.Value
                        });
        ...
        public async Task<AboutGetDTO?> GetFirst()
        {
            About? entity = await _repository.GetQuery()
                .Include(h => h.Translations)
            ...
            return entity == null ? null : _mapper.Map<AboutGetDTO>(entity);
        }
    }
}
