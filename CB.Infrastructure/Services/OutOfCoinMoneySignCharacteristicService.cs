...
{
    public class OutOfCoinMoneySignCharacteristicService : IOutOfCoinMoneySignCharacteristicService
    {
        private readonly IGenericRepository<MoneySignCharacteristic> _repository;
        private readonly IGenericRepository<Language> _languageRepository;
        private readonly IMapper _mapper;

        public OutOfCoinMoneySignCharacteristicService(
        ...
        public async Task<List<OutOfCoinMoneySignCharacteristicGetDTO>> GetAllAsync()
        {
            ...
            List<OutOfCoinMoneySignCharacteristicGetDTO> data = _mapper.Map<List<OutOfCoinMoneySignCharacteristicGetDTO>>(entities);
        ...
        public async Task<OutOfCoinMoneySignCharacteristicGetDTO?> GetByIdAsync(int id)
        {
            ...
            OutOfCoinMoneySignCharacteristicGetDTO? data = _mapper.Map<OutOfCoinMoneySignCharacteristicGetDTO>(entity);
            data.MoneySignHistoryTitle = entity.MoneySignHistory?.Translations.FirstOrDefault(x => x.LanguageId == 1)?.Title;
            return data;
        }
        public async Task<bool> CreateAsync(OutOfCoinMoneySignCharacteristicCreateDTO dto)
        {
        ...
        public async Task<bool> UpdateAsync(int id, OutOfCoinMoneySignCharacteristicEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
