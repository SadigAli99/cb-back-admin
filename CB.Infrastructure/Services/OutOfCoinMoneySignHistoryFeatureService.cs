...
{
    public class OutOfCoinMoneySignHistoryFeatureService : IOutOfCoinMoneySignHistoryFeatureService
    {
        private readonly IGenericRepository<MoneySignHistoryFeature> _repository;
        private readonly IGenericRepository<Language> _languageRepository;
        private readonly IMapper _mapper;

        public OutOfCoinMoneySignHistoryFeatureService(
            IMapper mapper,
        ...
        public async Task<bool> CreateOrUpdate(OutOfCoinMoneySignHistoryFeaturePostDTO dto)
        {
            ...
            MoneySignHistoryFeature? entity = await _repository.GetQuery()
                                        ...
                                        .FirstOrDefaultAsync(x => x.MoneySignHistory.MoneySign.Type == MoneySignType.COINOUT);
        ...
        public async Task<OutOfCoinMoneySignHistoryFeatureGetDTO?> GetFirst()
        {
            MoneySignHistoryFeature? entity = await _repository.GetQuery()
                .Include(h => h.Translations)
            ...
            var data = _mapper.Map<OutOfCoinMoneySignHistoryFeatureGetDTO>(entity);
