...
namespace CB.Infrastructure.Services
{
    public class StockExchangeCaptionService : IStockExchangeCaptionService
    {
        ...
        public async Task<bool> CreateOrUpdate(StockExchangeCaptionPostDTO dto)
        {
            ...
            StockExchangeCaption? about = await _repository.GetQuery()
            ...
            if (about is null)
            {
                about = _mapper.Map<StockExchangeCaption>(dto);
            ...
            else
            {
                ...
                foreach (var v in dto.Descriptions)
                {
                    ...
                    {
                        about.Translations.Add(new StockExchangeCaptionTranslation
                        {
                            LanguageId = lang.Id,
                            Description = v.Value
                        });
        ...
        public async Task<StockExchangeCaptionGetDTO?> GetFirst()
        {
            ...
            return about == null ? null : _mapper.Map<StockExchangeCaptionGetDTO>(about);
        }
    }
}
