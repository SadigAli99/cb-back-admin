...
namespace CB.Infrastructure.Services
{
    ...
    {
        private readonly IGenericRepository<Interview> _repository;
        ...
        public async Task<List<InterviewGetDTO>> GetAllAsync()
        {
            ...
            List<InterviewGetDTO> data = _mapper.Map<List<InterviewGetDTO>>(entities);
            return data;
        }
        public async Task<InterviewGetDTO?> GetByIdAsync(int id)
        {
            ...
            InterviewGetDTO? data = entity is null ? null : _mapper.Map<InterviewGetDTO>(entity);
        ...
        public async Task<bool> CreateAsync(InterviewCreateDTO dto)
        {
            ...
            var entity = _mapper.Map<Interview>(dto);
            ...
            entity.Translations = dto.Titles.Select(t =>
            {
                ...
                return new InterviewTranslation
                {
                    LanguageId = lang.Id,
                    Title = t.Value,
                };
        ...
        public async Task<bool> UpdateAsync(int id, InterviewEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
