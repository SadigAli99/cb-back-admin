...
namespace CB.Infrastructure.Services
{
    public class DigitalPaymentService : IDigitalPaymentService
    {
        ...
        public async Task<List<DigitalPaymentGetDTO>> GetAllAsync()
        {
            ...
            List<DigitalPaymentGetDTO> data = _mapper.Map<List<DigitalPaymentGetDTO>>(entities);
            return data;
        }
        public async Task<DigitalPaymentGetDTO?> GetByIdAsync(int id)
        {
            ...
            DigitalPaymentGetDTO? data = entity is null ? null : _mapper.Map<DigitalPaymentGetDTO>(entity);

            return data;
        }
        public async Task<bool> CreateAsync(DigitalPaymentCreateDTO dto)
        {
            ...
            entity.Translations = dto.Titles.Select(t =>
            {
                ...
                return new DigitalPaymentTranslation
                {
                    LanguageId = lang.Id,
        ...
        public async Task<bool> UpdateAsync(int id, DigitalPaymentEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
