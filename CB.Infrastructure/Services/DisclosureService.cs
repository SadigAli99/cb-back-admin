...
namespace CB.Infrastructure.Services
{
    public class DisclosureService : IDisclosureService
    {
        ...
        public async Task<List<DisclosureGetDTO>> GetAllAsync()
        {
            ...
            List<DisclosureGetDTO> data = _mapper.Map<List<DisclosureGetDTO>>(entities);
            return data;
        }
        public async Task<DisclosureGetDTO?> GetByIdAsync(int id)
        {
            ...
            DisclosureGetDTO? data = entity is null ? null : _mapper.Map<DisclosureGetDTO>(entity);

            return data;
        }
        public async Task<bool> CreateAsync(DisclosureCreateDTO dto)
        {
            ...
            entity.Translations = dto.Titles.Select(t =>
            {
                ...
                return new DisclosureTranslation
                {
                    LanguageId = lang.Id,
                    Title = t.Value,
        ...
        public async Task<bool> UpdateAsync(int id, DisclosureEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
