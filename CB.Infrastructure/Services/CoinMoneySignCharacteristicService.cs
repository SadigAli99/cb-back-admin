...
{
    public class CoinMoneySignCharacteristicService : ICoinMoneySignCharacteristicService
    {
        private readonly IGenericRepository<MoneySignCharacteristic> _repository;
        private readonly IGenericRepository<Language> _languageRepository;
        private readonly IMapper _mapper;

        public CoinMoneySignCharacteristicService(
        ...
        public async Task<List<CoinMoneySignCharacteristicGetDTO>> GetAllAsync()
        {
            ...
            List<CoinMoneySignCharacteristicGetDTO> data = _mapper.Map<List<CoinMoneySignCharacteristicGetDTO>>(entities);
        ...
        public async Task<CoinMoneySignCharacteristicGetDTO?> GetByIdAsync(int id)
        {
            ...
            CoinMoneySignCharacteristicGetDTO? data = _mapper.Map<CoinMoneySignCharacteristicGetDTO>(entity);
            data.MoneySignHistoryTitle = entity.MoneySignHistory?.Translations.FirstOrDefault(x => x.LanguageId == 1)?.Title;
            return data;
        }
        public async Task<bool> CreateAsync(CoinMoneySignCharacteristicCreateDTO dto)
        {
        ...
        public async Task<bool> UpdateAsync(int id, CoinMoneySignCharacteristicEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
