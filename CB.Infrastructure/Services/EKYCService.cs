...
namespace CB.Infrastructure.Services
{
    ...
    {
        private readonly IGenericRepository<EKYC> _repository;
        private readonly IGenericRepository<Language> _languageRepository;
        private readonly IMapper _mapper;

        public EKYCService(
            IMapper mapper,
            IGenericRepository<EKYC> repository,
        ...
        public async Task<bool> CreateOrUpdate(EKYCPostDTO dto)
        {
            var languages = await _languageRepository.GetAllAsync();
            EKYC? entity = await _repository.GetQuery()
            ...
            else
            {
                ...
                foreach (var v in dto.Descriptions)
                {
                    ...
                    {
                        entity.Translations.Add(new EKYCTranslation
                        {
                            LanguageId = lang.Id,
                            Description = v.Value
                        });
        ...
        public async Task<EKYCGetDTO?> GetFirst()
        {
            EKYC? entity = await _repository.GetQuery()
                .Include(h => h.Translations)
            ...
            return entity == null ? null : _mapper.Map<EKYCGetDTO>(entity);
        }
    }
}
