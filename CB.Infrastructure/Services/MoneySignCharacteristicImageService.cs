...
{
    public class MoneySignCharacteristicImageService : IMoneySignCharacteristicImageService
    {
        ...
        public MoneySignCharacteristicImageService(
        ...
        public async Task<List<MoneySignCharacteristicImageGetDTO>> GetAllAsync()
        {
            ...
            List<MoneySignCharacteristicImageGetDTO> data = _mapper.Map<List<MoneySignCharacteristicImageGetDTO>>(entities);
            foreach (MoneySignCharacteristicImageGetDTO item in data)
            {
        ...
        public async Task<MoneySignCharacteristicImageGetDTO?> GetByIdAsync(int id)
        {
            ...
            MoneySignCharacteristicImageGetDTO? data = _mapper.Map<MoneySignCharacteristicImageGetDTO>(entity);
        ...
        public async Task<bool> CreateAsync(MoneySignCharacteristicImageCreateDTO dto)
        {
        ...
        public async Task<bool> UpdateAsync(int id, MoneySignCharacteristicImageEditDTO dto)
        {
            var entity = await _repository.GetQuery()
                        .Include(b => b.Translations)
                        .ThenInclude(bt => bt.Language)
