...
namespace CB.Application.Validators.InvestmentCompanyFile
{
    public class InvestmentCompanyFileCreateValidator : AbstractValidator<InvestmentCompanyFileCreateDTO>
    {
        public InvestmentCompanyFileCreateValidator()
        {
            RuleFor(x => x.File)
