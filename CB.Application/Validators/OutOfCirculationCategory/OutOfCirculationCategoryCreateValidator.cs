...
{
    public class OutOfCirculationCategoryCreateValidator : AbstractValidator<OutOfCirculationCategoryCreateDTO>
    {
        public OutOfCirculationCategoryCreateValidator()
        {
            RuleFor(x => x.File)
