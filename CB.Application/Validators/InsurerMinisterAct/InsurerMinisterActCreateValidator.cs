...
namespace CB.Application.Validators.InsurerMinisterAct
{
    public class InsurerMinisterActCreateValidator : AbstractValidator<InsurerMinisterActCreateDTO>
    {
        public InsurerMinisterActCreateValidator()
        {
            RuleFor(x => x.File)
