...
namespace CB.Application.Validators.MoneySignCharacteristic
{
    public class MoneySignCharacteristicCreateValidator : AbstractValidator<MoneySignCharacteristicCreateDTO>
    {
        public MoneySignCharacteristicCreateValidator(
