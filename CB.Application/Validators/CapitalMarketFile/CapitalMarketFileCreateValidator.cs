...
namespace CB.Application.Validators.CapitalMarketFile
{
    public class CapitalMarketFileCreateValidator : AbstractValidator<CapitalMarketFileCreateDTO>
    {
        public CapitalMarketFileCreateValidator()
        {
            RuleFor(x => x.File)
