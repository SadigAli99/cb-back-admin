...
namespace CB.Application.Validators.OutOfBankNoteMoneySignCharacteristicImage
{
    public class OutOfBankNoteMoneySignCharacteristicImageCreateValidator : AbstractValidator<OutOfBankNoteMoneySignCharacteristicImageCreateDTO>
    {
        public OutOfBankNoteMoneySignCharacteristicImageCreateValidator(IOutOfBankNoteMoneySignHistoryService moneySignHistoryService)
        {
