...
{
    public class OutOfBankNoteMoneySignCharacteristicImageEditValidator : AbstractValidator<OutOfBankNoteMoneySignCharacteristicImageEditDTO>
    {
        public OutOfBankNoteMoneySignCharacteristicImageEditValidator(IOutOfBankNoteMoneySignHistoryService moneySignHistoryService)
        {
