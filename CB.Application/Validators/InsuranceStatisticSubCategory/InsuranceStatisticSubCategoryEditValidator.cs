...
{
    public class InsuranceStatisticSubCategoryEditValidator : AbstractValidator<InsuranceStatisticSubCategoryEditDTO>
    {
        public InsuranceStatisticSubCategoryEditValidator(IInsuranceStatisticCategoryService insuranceStatisticCategoryService)
        {
