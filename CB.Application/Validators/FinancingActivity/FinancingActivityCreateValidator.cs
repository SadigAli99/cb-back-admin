...
namespace CB.Application.Validators.FinancingActivity
{
    public class FinancingActivityCreateValidator : AbstractValidator<FinancingActivityCreateDTO>
    {
        public FinancingActivityCreateValidator()
        {
            RuleFor(x => x.File)
