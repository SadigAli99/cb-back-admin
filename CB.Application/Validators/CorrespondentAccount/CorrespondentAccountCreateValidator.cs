...
namespace CB.Application.Validators.CorrespondentAccount
{
    public class CorrespondentAccountCreateValidator : AbstractValidator<CorrespondentAccountCreateDTO>
    {
        public CorrespondentAccountCreateValidator()
        {
            RuleFor(x => x.File)
