...
namespace CB.Application.Validators.QualificationCertificate
{
    public class QualificationCertificateCreateValidator : AbstractValidator<QualificationCertificateCreateDTO>
    {
        public QualificationCertificateCreateValidator()
        {
            RuleFor(x => x.File)
