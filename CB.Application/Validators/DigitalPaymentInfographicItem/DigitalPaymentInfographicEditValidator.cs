...
{
    public class DigitalPaymentInfographicItemEditValidator : AbstractValidator<DigitalPaymentInfographicItemEditDTO>
    {
        public DigitalPaymentInfographicItemEditValidator(
