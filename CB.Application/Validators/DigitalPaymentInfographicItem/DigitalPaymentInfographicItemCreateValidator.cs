...
namespace CB.Application.Validators.DigitalPaymentInfographicItem
{
    public class DigitalPaymentInfographicItemCreateValidator : AbstractValidator<DigitalPaymentInfographicItemCreateDTO>
    {
        public DigitalPaymentInfographicItemCreateValidator(
            IDigitalPaymentInfographicService digitalPaymentService
        )
        {

            RuleFor(x => x.DigitalPaymentInfographicId)
