...
namespace CB.Application.Validators.EconometricModelFile
{
    public class EconometricModelFileCreateValidator : AbstractValidator<EconometricModelFileCreateDTO>
    {
        public EconometricModelFileCreateValidator()
        {
            RuleFor(x => x.File)
