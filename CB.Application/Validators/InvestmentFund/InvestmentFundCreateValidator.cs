...
namespace CB.Application.Validators.InvestmentFund
{
    public class InvestmentFundCreateValidator : AbstractValidator<InvestmentFundCreateDTO>
    {
        public InvestmentFundCreateValidator()
        {
