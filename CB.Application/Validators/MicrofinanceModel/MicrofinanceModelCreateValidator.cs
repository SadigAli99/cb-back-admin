...
namespace CB.Application.Validators.MicrofinanceModel
{
    public class MicrofinanceModelCreateValidator : AbstractValidator<MicrofinanceModelCreateDTO>
    {
        public MicrofinanceModelCreateValidator()
        {
            RuleFor(x => x.File)
