...
namespace CB.Application.Validators.ManagerContact
{
    public class ManagerContactCreateValidator : AbstractValidator<ManagerContactCreateDTO>
    {
        public ManagerContactCreateValidator(IManagerService directorService)
        {
