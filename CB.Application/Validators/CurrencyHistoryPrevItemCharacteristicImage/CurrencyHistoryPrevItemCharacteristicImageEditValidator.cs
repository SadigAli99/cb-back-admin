...
{
    public class CurrencyHistoryPrevItemCharacteristicImageEditValidator : AbstractValidator<CurrencyHistoryPrevItemCharacteristicImageEditDTO>
    {
        public CurrencyHistoryPrevItemCharacteristicImageEditValidator(ICurrencyHistoryPrevService CurrencyHistoryPrevService)
        {
