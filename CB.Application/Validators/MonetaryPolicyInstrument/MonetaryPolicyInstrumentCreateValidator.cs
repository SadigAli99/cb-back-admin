...
namespace CB.Application.Validators.MonetaryPolicyInstrument
{
    public class MonetaryPolicyInstrumentCreateValidator : AbstractValidator<MonetaryPolicyInstrumentCreateDTO>
    {
        public MonetaryPolicyInstrumentCreateValidator()
        {
            RuleFor(x => x.File)
