...
namespace CB.Application.Validators.RegistrationSecurity
{
    public class RegistrationSecurityCreateValidator : AbstractValidator<RegistrationSecurityCreateDTO>
    {
        public RegistrationSecurityCreateValidator()
        {
