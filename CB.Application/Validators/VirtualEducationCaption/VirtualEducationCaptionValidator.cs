...
namespace CB.Application.Validators.VirtualEducationCaption
{
    public class VirtualEducationCaptionValidator : AbstractValidator<VirtualEducationCaptionPostDTO>
    {
        public VirtualEducationCaptionValidator()
        {
