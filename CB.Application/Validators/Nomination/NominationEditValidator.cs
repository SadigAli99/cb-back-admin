...
{
    public class NominationEditValidator : AbstractValidator<NominationEditDTO>
    {
        public NominationEditValidator(INominationCategoryService participantCategoryService)
        {
