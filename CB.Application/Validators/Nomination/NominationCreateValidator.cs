...
namespace CB.Application.Validators.Nomination
{
    public class NominationCreateValidator : AbstractValidator<NominationCreateDTO>
    {
        public NominationCreateValidator(INominationCategoryService participantCategoryService)
        {
            ...
            RuleFor(x => x.NominationCategoryId)
