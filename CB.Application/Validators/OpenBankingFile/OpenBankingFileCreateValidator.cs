...
namespace CB.Application.Validators.OpenBankingFile
{
    public class OpenBankingFileCreateValidator : AbstractValidator<OpenBankingFileCreateDTO>
    {
        public OpenBankingFileCreateValidator()
        {
            RuleFor(x => x.File)
