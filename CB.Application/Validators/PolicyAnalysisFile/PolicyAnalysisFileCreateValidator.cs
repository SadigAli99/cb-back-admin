...
namespace CB.Application.Validators.PolicyAnalysisFile
{
    public class PolicyAnalysisFileCreateValidator : AbstractValidator<PolicyAnalysisFileCreateDTO>
    {
        public PolicyAnalysisFileCreateValidator()
        {
            RuleFor(x => x.File)
