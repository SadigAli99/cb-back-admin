...
namespace CB.Application.Validators.ExecutionStatus
{
    public class ExecutionStatusCreateValidator : AbstractValidator<ExecutionStatusCreateDTO>
    {
        public ExecutionStatusCreateValidator()
        {
