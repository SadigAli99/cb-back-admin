...
{
    public class MoneySignCharacteristicImageEditValidator : AbstractValidator<MoneySignCharacteristicImageEditDTO>
    {
        public MoneySignCharacteristicImageEditValidator(IMoneySignHistoryService moneySignHistoryService)
        {
