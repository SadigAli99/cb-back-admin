...
namespace CB.Application.Validators.NonBankFile
{
    public class NonBankFileCreateValidator : AbstractValidator<NonBankFileCreateDTO>
    {
        public NonBankFileCreateValidator()
        {
            RuleFor(x => x.File)
