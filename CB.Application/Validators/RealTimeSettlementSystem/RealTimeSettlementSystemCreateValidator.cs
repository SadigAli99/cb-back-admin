...
{
    public class RealTimeSettlementSystemCreateValidator : AbstractValidator<RealTimeSettlementSystemCreateDTO>
    {
        public RealTimeSettlementSystemCreateValidator()
        {
