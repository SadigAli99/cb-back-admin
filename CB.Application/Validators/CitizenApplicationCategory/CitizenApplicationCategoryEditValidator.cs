...
{
    public class CitizenApplicationCategoryEditValidator : AbstractValidator<CitizenApplicationCategoryEditDTO>
    {
        public CitizenApplicationCategoryEditValidator()
        {
