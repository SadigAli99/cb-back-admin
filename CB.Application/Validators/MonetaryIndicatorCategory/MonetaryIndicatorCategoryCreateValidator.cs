...
namespace CB.Application.Validators.MonetaryIndicatorCategory
{
    public class MonetaryIndicatorCategoryCreateValidator : AbstractValidator<MonetaryIndicatorCategoryCreateDTO>
    {
        public MonetaryIndicatorCategoryCreateValidator()
        {
