...
namespace CB.Application.Validators.MacroEconomy
{
    public class MacroEconomyCreateValidator : AbstractValidator<MacroEconomyCreateDTO>
    {
        public MacroEconomyCreateValidator()
        {
            RuleFor(x => x.File)
