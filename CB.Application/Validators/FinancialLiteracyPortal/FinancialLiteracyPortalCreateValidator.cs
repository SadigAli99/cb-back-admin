...
namespace CB.Application.Validators.FinancialLiteracyPortal
{
    public class FinancialLiteracyPortalCreateValidator : AbstractValidator<FinancialLiteracyPortalCreateDTO>
    {
        public FinancialLiteracyPortalCreateValidator()
        {
