...
namespace CB.Application.Validators.CoinMoneySign
{
    public class CoinMoneySignCreateValidator : AbstractValidator<CoinMoneySignCreateDTO>
    {
        public CoinMoneySignCreateValidator()
        {
            RuleFor(x => x.File)
