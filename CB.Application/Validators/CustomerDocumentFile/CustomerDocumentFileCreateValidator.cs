...
{
    public class CustomerDocumentFileCreateValidator : AbstractValidator<CustomerDocumentFileCreateDTO>
    {
        public CustomerDocumentFileCreateValidator(ICustomerDocumentService staffService)
        {
