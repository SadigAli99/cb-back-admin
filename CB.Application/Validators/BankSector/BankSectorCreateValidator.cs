...
{
    public class BankSectorCreateValidator : AbstractValidator<BankSectorCreateDTO>
    {
        public BankSectorCreateValidator(IBankSectorCategoryService percentCorridorCategoryService)
        {
            RuleFor(x => x.Date)
