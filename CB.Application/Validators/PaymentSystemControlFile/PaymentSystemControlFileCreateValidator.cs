...
namespace CB.Application.Validators.PaymentSystemControlFile
{
    public class PaymentSystemControlFileCreateValidator : AbstractValidator<PaymentSystemControlFileCreateDTO>
    {
        public PaymentSystemControlFileCreateValidator()
        {
            RuleFor(x => x.File)
                ...
                .WithMessage("Fayl yalnız pdf, xlsx, doc, zip və ya şəkil formatında ola bilər.");
