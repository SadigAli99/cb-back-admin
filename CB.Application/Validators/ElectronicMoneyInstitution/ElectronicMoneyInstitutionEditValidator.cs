...
{
    public class ElectronicMoneyInstitutionEditValidator : AbstractValidator<ElectronicMoneyInstitutionEditDTO>
    {
        public ElectronicMoneyInstitutionEditValidator()
        {
