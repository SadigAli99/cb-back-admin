...
namespace CB.Application.Validators.ElectronicMoneyInstitution
{
    public class ElectronicMoneyInstitutionCreateValidator : AbstractValidator<ElectronicMoneyInstitutionCreateDTO>
    {
        public ElectronicMoneyInstitutionCreateValidator()
        {
