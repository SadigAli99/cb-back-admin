...
namespace CB.Application.Validators.Methodology
{
    public class MethodologyCreateValidator : AbstractValidator<MethodologyCreateDTO>
    {
        public MethodologyCreateValidator()
        {
            RuleFor(x => x.File)
