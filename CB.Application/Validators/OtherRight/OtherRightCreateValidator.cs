...
namespace CB.Application.Validators.OtherRight
{
    public class OtherRightCreateValidator : AbstractValidator<OtherRightCreateDTO>
    {
        public OtherRightCreateValidator()
        {
            RuleFor(x => x.File)
