...
namespace CB.Application.Validators.LicensingProcess
{
    public class LicensingProcessCreateValidator : AbstractValidator<LicensingProcessCreateDTO>
    {
        public LicensingProcessCreateValidator()
        {
            RuleFor(x => x.File)
