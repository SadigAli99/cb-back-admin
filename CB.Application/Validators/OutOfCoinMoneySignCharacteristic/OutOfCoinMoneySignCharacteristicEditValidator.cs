...
{
    public class OutOfCoinMoneySignCharacteristicEditValidator : AbstractValidator<OutOfCoinMoneySignCharacteristicEditDTO>
    {
        public OutOfCoinMoneySignCharacteristicEditValidator(
