...
{
    public class MoneySignProtectionElementEditValidator : AbstractValidator<MoneySignProtectionElementEditDTO>
    {
        public MoneySignProtectionElementEditValidator()
        {
