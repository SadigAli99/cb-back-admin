...
namespace CB.Application.Validators.MoneySignProtectionElement
{
    public class MoneySignProtectionElementCreateValidator : AbstractValidator<MoneySignProtectionElementCreateDTO>
    {
        public MoneySignProtectionElementCreateValidator()
        {
