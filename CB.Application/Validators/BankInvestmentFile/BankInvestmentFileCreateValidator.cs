...
namespace CB.Application.Validators.BankInvestmentFile
{
    public class BankInvestmentFileCreateValidator : AbstractValidator<BankInvestmentFileCreateDTO>
    {
        public BankInvestmentFileCreateValidator()
        {
            RuleFor(x => x.File)
