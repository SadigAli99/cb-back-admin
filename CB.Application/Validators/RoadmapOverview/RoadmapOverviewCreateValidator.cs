...
namespace CB.Application.Validators.RoadmapOverview
{
    public class RoadmapOverviewCreateValidator : AbstractValidator<RoadmapOverviewCreateDTO>
    {
        public RoadmapOverviewCreateValidator()
        {
            RuleFor(x => x.File)
