...
namespace CB.Application.Validators.NakhchivanPublication
{
    public class NakhchivanPublicationCreateValidator : AbstractValidator<NakhchivanPublicationCreateDTO>
    {
        public NakhchivanPublicationCreateValidator()
        {
            RuleFor(x => x.File)
