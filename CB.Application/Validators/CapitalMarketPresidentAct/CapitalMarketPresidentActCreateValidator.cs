...
namespace CB.Application.Validators.CapitalMarketPresidentAct
{
    public class CapitalMarketPresidentActCreateValidator : AbstractValidator<CapitalMarketPresidentActCreateDTO>
    {
        public CapitalMarketPresidentActCreateValidator()
        {
            RuleFor(x => x.File)
