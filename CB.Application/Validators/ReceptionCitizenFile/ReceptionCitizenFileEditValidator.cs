...
{
    public class ReceptionCitizenFileEditValidator : AbstractValidator<ReceptionCitizenFileEditDTO>
    {
        public ReceptionCitizenFileEditValidator(IReceptionCitizenService receptionCitizenService)
        {
