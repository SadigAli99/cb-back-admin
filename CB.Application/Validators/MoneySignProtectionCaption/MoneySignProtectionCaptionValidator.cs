...
namespace CB.Application.Validators.MoneySignProtectionCaption
{
    public class MoneySignProtectionCaptionValidator : AbstractValidator<MoneySignProtectionCaptionPostDTO>
    {
        public MoneySignProtectionCaptionValidator(IMoneySignHistoryService moneySignHistoryService)
        {
