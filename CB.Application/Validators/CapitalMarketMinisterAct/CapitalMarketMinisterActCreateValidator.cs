...
namespace CB.Application.Validators.CapitalMarketMinisterAct
{
    public class CapitalMarketMinisterActCreateValidator : AbstractValidator<CapitalMarketMinisterActCreateDTO>
    {
        public CapitalMarketMinisterActCreateValidator()
        {
            RuleFor(x => x.File)
