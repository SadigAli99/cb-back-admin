...
namespace CB.Application.Validators.FraudStatistic
{
    public class FraudStatisticCreateValidator : AbstractValidator<FraudStatisticCreateDTO>
    {
        public FraudStatisticCreateValidator()
        {
