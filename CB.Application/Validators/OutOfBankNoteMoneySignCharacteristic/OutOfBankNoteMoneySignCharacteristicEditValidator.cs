...
{
    public class OutOfBankNoteMoneySignCharacteristicEditValidator : AbstractValidator<OutOfBankNoteMoneySignCharacteristicEditDTO>
    {
        public OutOfBankNoteMoneySignCharacteristicEditValidator(
