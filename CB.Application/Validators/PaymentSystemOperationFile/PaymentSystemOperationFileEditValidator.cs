...
{
    public class PaymentSystemOperationFileEditValidator : AbstractValidator<PaymentSystemOperationFileEditDTO>
    {
        public PaymentSystemOperationFileEditValidator()
        {
            RuleFor(x => x.File)
