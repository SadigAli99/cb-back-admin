...
namespace CB.Application.Validators.PaymentSystemOperationFile
{
    public class PaymentSystemOperationFileCreateValidator : AbstractValidator<PaymentSystemOperationFileCreateDTO>
    {
        public PaymentSystemOperationFileCreateValidator()
        {
            RuleFor(x => x.File)
