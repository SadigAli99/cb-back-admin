...
{
    public class MonetaryIndicatorEditValidator : AbstractValidator<MonetaryIndicatorEditDTO>
    {
        public MonetaryIndicatorEditValidator(IMonetaryIndicatorCategoryService percentCorridorCategoryService)
        {
            RuleFor(x => x.Date)
