...
namespace CB.Application.Validators.CybersecurityStrategy
{
    public class CybersecurityStrategyCreateValidator : AbstractValidator<CybersecurityStrategyCreateDTO>
    {
        public CybersecurityStrategyCreateValidator()
        {
            RuleFor(x => x.File)
