...
{
    public class ReceptionCitizenVideoCreateValidator : AbstractValidator<ReceptionCitizenVideoCreateDTO>
    {
        public ReceptionCitizenVideoCreateValidator(IReceptionCitizenCategoryService receptionCitizenCategoryService)
        {
