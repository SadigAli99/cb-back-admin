...
{
    public class CurrencyHistoryPrevItemCharacteristicCreateValidator : AbstractValidator<CurrencyHistoryPrevItemCharacteristicCreateDTO>
    {
        public CurrencyHistoryPrevItemCharacteristicCreateValidator(
            ICurrencyHistoryPrevItemService currencyHistoryPrevService
        )
        {
