...
namespace CB.Application.Validators.InsurerPresidentAct
{
    public class InsurerPresidentActCreateValidator : AbstractValidator<InsurerPresidentActCreateDTO>
    {
        public InsurerPresidentActCreateValidator()
        {
            RuleFor(x => x.File)
