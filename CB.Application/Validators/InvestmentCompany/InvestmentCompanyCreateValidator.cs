...
namespace CB.Application.Validators.InvestmentCompany
{
    public class InvestmentCompanyCreateValidator : AbstractValidator<InvestmentCompanyCreateDTO>
    {
        public InvestmentCompanyCreateValidator()
        {
