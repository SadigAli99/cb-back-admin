...
namespace CB.Application.Validators.PostalCommunication
{
    public class PostalCommunicationCreateValidator : AbstractValidator<PostalCommunicationCreateDTO>
    {
        public PostalCommunicationCreateValidator()
        {
            RuleFor(x => x.File)
