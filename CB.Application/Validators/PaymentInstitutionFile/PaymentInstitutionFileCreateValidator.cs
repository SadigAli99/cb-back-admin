...
namespace CB.Application.Validators.PaymentInstitutionFile
{
    public class PaymentInstitutionFileCreateValidator : AbstractValidator<PaymentInstitutionFileCreateDTO>
    {
        public PaymentInstitutionFileCreateValidator()
        {
            RuleFor(x => x.File)
