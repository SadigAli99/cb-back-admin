...
namespace CB.Application.Validators.LossAdjuster
{
    public class LossAdjusterCreateValidator : AbstractValidator<LossAdjusterCreateDTO>
    {
        public LossAdjusterCreateValidator()
        {
            RuleFor(x => x.File)
