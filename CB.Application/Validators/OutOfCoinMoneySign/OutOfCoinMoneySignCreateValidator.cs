...
namespace CB.Application.Validators.OutOfCoinMoneySign
{
    public class OutOfCoinMoneySignCreateValidator : AbstractValidator<OutOfCoinMoneySignCreateDTO>
    {
        public OutOfCoinMoneySignCreateValidator()
        {
            RuleFor(x => x.File)
