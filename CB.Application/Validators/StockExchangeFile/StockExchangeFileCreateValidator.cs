...
namespace CB.Application.Validators.StockExchangeFile
{
    public class StockExchangeFileCreateValidator : AbstractValidator<StockExchangeFileCreateDTO>
    {
        public StockExchangeFileCreateValidator()
        {
            RuleFor(x => x.File)
