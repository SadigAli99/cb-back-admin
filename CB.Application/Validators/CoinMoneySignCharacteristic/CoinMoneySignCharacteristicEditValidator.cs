...
{
    public class CoinMoneySignCharacteristicEditValidator : AbstractValidator<CoinMoneySignCharacteristicEditDTO>
    {
        public CoinMoneySignCharacteristicEditValidator(
