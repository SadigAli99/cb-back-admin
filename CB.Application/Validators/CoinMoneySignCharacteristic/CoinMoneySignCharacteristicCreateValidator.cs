...
namespace CB.Application.Validators.CoinMoneySignCharacteristic
{
    public class CoinMoneySignCharacteristicCreateValidator : AbstractValidator<CoinMoneySignCharacteristicCreateDTO>
    {
        public CoinMoneySignCharacteristicCreateValidator(
