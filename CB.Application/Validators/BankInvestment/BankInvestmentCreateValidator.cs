...
namespace CB.Application.Validators.BankInvestment
{
    public class BankInvestmentCreateValidator : AbstractValidator<BankInvestmentCreateDTO>
    {
        public BankInvestmentCreateValidator()
        {
