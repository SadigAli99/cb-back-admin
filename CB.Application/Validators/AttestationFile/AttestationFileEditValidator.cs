...
{
    public class AttestationFileEditValidator : AbstractValidator<AttestationFileEditDTO>
    {
        public AttestationFileEditValidator(IAttestationService attestationService)
        {
