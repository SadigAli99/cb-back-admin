...
namespace CB.Application.Validators.LegalBasis
{
    public class LegalBasisCreateValidator : AbstractValidator<LegalBasisCreateDTO>
    {
        public LegalBasisCreateValidator()
        {
            RuleFor(x => x.File)
