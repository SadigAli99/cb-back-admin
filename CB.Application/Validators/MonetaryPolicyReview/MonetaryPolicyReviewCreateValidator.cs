...
namespace CB.Application.Validators.MonetaryPolicyReview
{
    public class MonetaryPolicyReviewCreateValidator : AbstractValidator<MonetaryPolicyReviewCreateDTO>
    {
        public MonetaryPolicyReviewCreateValidator()
        {
            RuleFor(x => x.File)
