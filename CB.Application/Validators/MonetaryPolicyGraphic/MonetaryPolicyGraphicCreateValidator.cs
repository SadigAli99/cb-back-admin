...
namespace CB.Application.Validators.MonetaryPolicyGraphic
{
    public class MonetaryPolicyGraphicCreateValidator : AbstractValidator<MonetaryPolicyGraphicCreateDTO>
    {
        public MonetaryPolicyGraphicCreateValidator()
        {
