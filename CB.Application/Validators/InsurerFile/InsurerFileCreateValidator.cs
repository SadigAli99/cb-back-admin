...
namespace CB.Application.Validators.InsurerFile
{
    public class InsurerFileCreateValidator : AbstractValidator<InsurerFileCreateDTO>
    {
        public InsurerFileCreateValidator()
        {
            RuleFor(x => x.File)
