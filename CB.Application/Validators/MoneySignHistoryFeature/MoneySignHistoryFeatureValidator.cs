...
namespace CB.Application.Validators.MoneySignHistoryFeature
{
    public class MoneySignHistoryFeatureValidator : AbstractValidator<MoneySignHistoryFeaturePostDTO>
    {
        public MoneySignHistoryFeatureValidator(IMoneySignHistoryService moneySignHistoryService)
        {
