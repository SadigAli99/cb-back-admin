...
namespace CB.Application.Validators.PaymentRight
{
    public class PaymentRightCreateValidator : AbstractValidator<PaymentRightCreateDTO>
    {
        public PaymentRightCreateValidator()
        {
            RuleFor(x => x.File)
