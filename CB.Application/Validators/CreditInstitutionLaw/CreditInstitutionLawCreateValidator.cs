...
namespace CB.Application.Validators.CreditInstitutionLaw
{
    public class CreditInstitutionLawCreateValidator : AbstractValidator<CreditInstitutionLawCreateDTO>
    {
        public CreditInstitutionLawCreateValidator()
        {
            RuleFor(x => x.File)
