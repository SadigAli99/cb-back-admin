...
{
    public class TerritorialOfficeRegionCreateValidator : AbstractValidator<TerritorialOfficeRegionCreateDTO>
    {
        public TerritorialOfficeRegionCreateValidator(ITerritorialOfficeService territorialOfficeService)
        {
            ...
            RuleFor(x => x.File)
                ...
                .WithMessage("Fayl yalnız şəkil formatında ola bilər.");
