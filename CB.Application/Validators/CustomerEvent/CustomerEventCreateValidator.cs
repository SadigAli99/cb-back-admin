...
namespace CB.Application.Validators.CustomerEvent
{
    public class CustomerEventCreateValidator : AbstractValidator<CustomerEventCreateDTO>
    {
        public CustomerEventCreateValidator()
        {
