...
namespace CB.Application.Validators.LegalActMethodology
{
    public class LegalActMethodologyCreateValidator : AbstractValidator<LegalActMethodologyCreateDTO>
    {
        public LegalActMethodologyCreateValidator()
        {
            RuleFor(x => x.File)
