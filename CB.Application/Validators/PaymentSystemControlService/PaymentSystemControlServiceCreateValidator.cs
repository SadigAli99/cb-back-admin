...
namespace CB.Application.Validators.PaymentSystemControlService
{
    public class PaymentSystemControlServiceCreateValidator : AbstractValidator<PaymentSystemControlServiceCreateDTO>
    {
        public PaymentSystemControlServiceCreateValidator()
        {
