...
{
    public class ControlMeasureEditValidator : AbstractValidator<ControlMeasureEditDTO>
    {
        public ControlMeasureEditValidator(IControlMeasureCategoryService controlMeasureCategoryService)
        {
