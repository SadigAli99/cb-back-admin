...
{
    public class ElectronicMoneyInstitutionFileEditValidator : AbstractValidator<ElectronicMoneyInstitutionFileEditDTO>
    {
        public ElectronicMoneyInstitutionFileEditValidator()
        {
            RuleFor(x => x.File)
