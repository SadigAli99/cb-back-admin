...
namespace CB.Application.Validators.InformationIssuer
{
    public class InformationIssuerCreateValidator : AbstractValidator<InformationIssuerCreateDTO>
    {
        public InformationIssuerCreateValidator()
        {
            RuleFor(x => x.File)
