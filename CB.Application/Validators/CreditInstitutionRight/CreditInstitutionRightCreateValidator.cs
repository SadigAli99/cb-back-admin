...
namespace CB.Application.Validators.CreditInstitutionRight
{
    public class CreditInstitutionRightCreateValidator : AbstractValidator<CreditInstitutionRightCreateDTO>
    {
        public CreditInstitutionRightCreateValidator()
        {
            RuleFor(x => x.File)
