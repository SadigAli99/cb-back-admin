...
{
    public class DigitalPaymentInfographicCreateValidator : AbstractValidator<DigitalPaymentInfographicCreateDTO>
    {
        public DigitalPaymentInfographicCreateValidator(
