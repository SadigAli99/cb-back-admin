...
namespace CB.Application.Validators.InformationMemorandum
{
    public class InformationMemorandumCreateValidator : AbstractValidator<InformationMemorandumCreateDTO>
    {
        public InformationMemorandumCreateValidator()
        {
            RuleFor(x => x.File)
