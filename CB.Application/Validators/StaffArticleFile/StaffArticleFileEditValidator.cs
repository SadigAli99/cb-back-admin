...
{
    public class StaffArticleFileEditValidator : AbstractValidator<StaffArticleFileEditDTO>
    {
        public StaffArticleFileEditValidator(IStaffArticleService staffService)
        {
