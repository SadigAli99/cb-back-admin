...
namespace CB.Application.Validators.StaffArticleFile
{
    public class StaffArticleFileCreateValidator : AbstractValidator<StaffArticleFileCreateDTO>
    {
        public StaffArticleFileCreateValidator(IStaffArticleService staffService)
        {
