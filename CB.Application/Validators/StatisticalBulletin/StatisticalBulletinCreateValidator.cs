...
namespace CB.Application.Validators.StatisticalBulletin
{
    public class StatisticalBulletinCreateValidator : AbstractValidator<StatisticalBulletinCreateDTO>
    {
        public StatisticalBulletinCreateValidator()
        {
            RuleFor(x => x.File)
