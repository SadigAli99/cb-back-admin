...
namespace CB.Application.Validators.PaymentInstitution
{
    public class PaymentInstitutionCreateValidator : AbstractValidator<PaymentInstitutionCreateDTO>
    {
        public PaymentInstitutionCreateValidator()
        {
