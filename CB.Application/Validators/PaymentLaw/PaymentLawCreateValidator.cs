...
namespace CB.Application.Validators.PaymentLaw
{
    public class PaymentLawCreateValidator : AbstractValidator<PaymentLawCreateDTO>
    {
        public PaymentLawCreateValidator()
        {
            RuleFor(x => x.File)
