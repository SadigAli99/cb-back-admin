...
namespace CB.Application.Validators.DigitalPayment
{
    public class DigitalPaymentCreateValidator : AbstractValidator<DigitalPaymentCreateDTO>
    {
        public DigitalPaymentCreateValidator()
        {
            RuleFor(x => x.File)
