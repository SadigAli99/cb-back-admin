...
namespace CB.Application.Validators.OutOfCoinMoneySignHistoryFeature
{
    public class OutOfCoinMoneySignHistoryFeatureValidator : AbstractValidator<OutOfCoinMoneySignHistoryFeaturePostDTO>
    {
        public OutOfCoinMoneySignHistoryFeatureValidator(IOutOfCoinMoneySignHistoryService moneySignHistoryService)
        {
