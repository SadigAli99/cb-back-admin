...
namespace CB.Application.Validators.ReviewApplicationVideo
{
    public class ReviewApplicationVideoCreateValidator : AbstractValidator<ReviewApplicationVideoCreateDTO>
    {
        public ReviewApplicationVideoCreateValidator(IReviewApplicationService receptionCitizenCategoryService)
        {
