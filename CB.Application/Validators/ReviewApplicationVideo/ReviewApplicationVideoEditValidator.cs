...
{
    public class ReviewApplicationVideoEditValidator : AbstractValidator<ReviewApplicationVideoEditDTO>
    {
        public ReviewApplicationVideoEditValidator(IReviewApplicationService receptionCitizenCategoryService)
        {
