...
namespace CB.Application.Validators.TerritorialOfficeStatistic
{
    public class TerritorialOfficeStatisticCreateValidator : AbstractValidator<TerritorialOfficeStatisticCreateDTO>
    {
        public TerritorialOfficeStatisticCreateValidator(
        ...
        )
        {
            ...
            RuleFor(x => x.TerritorialOfficeId)
                    ...
                    .WithMessage("Seçilən ofia yanlışdır");
