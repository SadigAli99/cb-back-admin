...
{
    public class TerritorialOfficeStatisticEditValidator : AbstractValidator<TerritorialOfficeStatisticEditDTO>
    {
        public TerritorialOfficeStatisticEditValidator(
