...
{
    public class CreditInstitutionMinisterActEditValidator : AbstractValidator<CreditInstitutionMinisterActEditDTO>
    {
        public CreditInstitutionMinisterActEditValidator()
        {
            RuleFor(x => x.File)
