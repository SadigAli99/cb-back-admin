...
namespace CB.Application.Validators.CreditInstitutionMinisterAct
{
    public class CreditInstitutionMinisterActCreateValidator : AbstractValidator<CreditInstitutionMinisterActCreateDTO>
    {
        public CreditInstitutionMinisterActCreateValidator()
        {
            RuleFor(x => x.File)
