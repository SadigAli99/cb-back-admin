...
namespace CB.Application.Validators.DigitalPaymentReview
{
    public class DigitalPaymentReviewCreateValidator : AbstractValidator<DigitalPaymentReviewCreateDTO>
    {
        public DigitalPaymentReviewCreateValidator()
        {
            RuleFor(x => x.File)
