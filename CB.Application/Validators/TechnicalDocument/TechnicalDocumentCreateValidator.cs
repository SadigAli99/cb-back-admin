...
namespace CB.Application.Validators.TechnicalDocument
{
    public class TechnicalDocumentCreateValidator : AbstractValidator<TechnicalDocumentCreateDTO>
    {
        public TechnicalDocumentCreateValidator()
        {
            RuleFor(x => x.File)
