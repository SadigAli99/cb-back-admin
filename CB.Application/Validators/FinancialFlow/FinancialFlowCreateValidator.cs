...
namespace CB.Application.Validators.FinancialFlow
{
    public class FinancialFlowCreateValidator : AbstractValidator<FinancialFlowCreateDTO>
    {
        public FinancialFlowCreateValidator()
        {
            RuleFor(x => x.File)
