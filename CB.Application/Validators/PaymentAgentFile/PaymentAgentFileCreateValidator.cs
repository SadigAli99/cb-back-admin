...
namespace CB.Application.Validators.PaymentAgentFile
{
    public class PaymentAgentFileCreateValidator : AbstractValidator<PaymentAgentFileCreateDTO>
    {
        public PaymentAgentFileCreateValidator()
        {
            RuleFor(x => x.File)
