...
{
    public class ReviewApplicationFileEditValidator : AbstractValidator<ReviewApplicationFileEditDTO>
    {
        public ReviewApplicationFileEditValidator(IReviewApplicationService staffService)
        {
