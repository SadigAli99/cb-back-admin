...
namespace CB.Application.Validators.ReviewApplicationFile
{
    public class ReviewApplicationFileCreateValidator : AbstractValidator<ReviewApplicationFileCreateDTO>
    {
        public ReviewApplicationFileCreateValidator(IReviewApplicationService staffService)
        {
