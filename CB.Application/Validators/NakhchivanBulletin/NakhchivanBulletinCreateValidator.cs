...
namespace CB.Application.Validators.NakhchivanBulletin
{
    public class NakhchivanBulletinCreateValidator : AbstractValidator<NakhchivanBulletinCreateDTO>
    {
        public NakhchivanBulletinCreateValidator()
        {
            RuleFor(x => x.File)
