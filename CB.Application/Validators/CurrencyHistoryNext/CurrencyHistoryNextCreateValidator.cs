...
{
    public class CurrencyHistoryNextCreateValidator : AbstractValidator<CurrencyHistoryNextCreateDTO>
    {
        public CurrencyHistoryNextCreateValidator(ICurrencyHistoryService currencyHistoryService)
        {
