...
namespace CB.Application.Validators.PaymentSystemOperation
{
    public class PaymentSystemOperationCreateValidator : AbstractValidator<PaymentSystemOperationCreateDTO>
    {
        public PaymentSystemOperationCreateValidator()
        {
