...
namespace CB.Application.Validators.ExternalSection
{
    public class ExternalSectionCreateValidator : AbstractValidator<ExternalSectionCreateDTO>
    {
        public ExternalSectionCreateValidator()
        {
            RuleFor(x => x.File)
