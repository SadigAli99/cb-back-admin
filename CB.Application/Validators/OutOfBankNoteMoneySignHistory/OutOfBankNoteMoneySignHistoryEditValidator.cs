...
{
    public class OutOfBankNoteMoneySignHistoryEditValidator : AbstractValidator<OutOfBankNoteMoneySignHistoryEditDTO>
    {
        public OutOfBankNoteMoneySignHistoryEditValidator(
