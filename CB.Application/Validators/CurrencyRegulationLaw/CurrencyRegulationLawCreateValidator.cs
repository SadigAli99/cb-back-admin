...
namespace CB.Application.Validators.CurrencyRegulationLaw
{
    public class CurrencyRegulationLawCreateValidator : AbstractValidator<CurrencyRegulationLawCreateDTO>
    {
        public CurrencyRegulationLawCreateValidator()
        {
            RuleFor(x => x.File)
