...
namespace CB.Application.Validators.LotteryFile
{
    public class LotteryFileCreateValidator : AbstractValidator<LotteryFileCreateDTO>
    {
        public LotteryFileCreateValidator(ILotteryService lotteryService)
        {
