...
namespace CB.Application.Validators.Regulation
{
    public class RegulationCreateValidator : AbstractValidator<RegulationCreateDTO>
    {
        public RegulationCreateValidator()
        {
            RuleFor(x => x.File)
