...
namespace CB.Application.Validators.ForeignInsuranceBroker
{
    public class ForeignInsuranceBrokerCreateValidator : AbstractValidator<ForeignInsuranceBrokerCreateDTO>
    {
        public ForeignInsuranceBrokerCreateValidator()
        {
            RuleFor(x => x.File)
