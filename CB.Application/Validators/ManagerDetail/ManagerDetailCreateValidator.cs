...
namespace CB.Application.Validators.ManagerDetail
{
    public class ManagerDetailCreateValidator : AbstractValidator<ManagerDetailCreateDTO>
    {
        public ManagerDetailCreateValidator(IManagerService directorService)
        {
