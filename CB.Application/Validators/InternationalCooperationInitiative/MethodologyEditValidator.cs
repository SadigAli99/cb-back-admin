...
{
    public class InternationalCooperationInitiativeEditValidator : AbstractValidator<InternationalCooperationInitiativeEditDTO>
    {
        public InternationalCooperationInitiativeEditValidator()
        {
            RuleFor(x => x.File)
