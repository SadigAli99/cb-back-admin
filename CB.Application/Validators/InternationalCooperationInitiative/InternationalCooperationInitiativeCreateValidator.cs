...
namespace CB.Application.Validators.InternationalCooperationInitiative
{
    public class InternationalCooperationInitiativeCreateValidator : AbstractValidator<InternationalCooperationInitiativeCreateDTO>
    {
        public InternationalCooperationInitiativeCreateValidator()
        {
            RuleFor(x => x.File)
