...
{
    public class ComplaintIndexEditValidator : AbstractValidator<ComplaintIndexEditDTO>
    {
        public ComplaintIndexEditValidator(IComplaintIndexCategoryService complaintIndexCategoryService)
        {
            RuleFor(x => x.Month)
