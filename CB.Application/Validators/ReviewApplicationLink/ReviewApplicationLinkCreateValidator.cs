...
{
    public class ReviewApplicationLinkCreateValidator : AbstractValidator<ReviewApplicationLinkCreateDTO>
    {
        public ReviewApplicationLinkCreateValidator(IReviewApplicationService receptionCitizenCategoryService)
        {
