...
{
    public class InsuranceStatisticCategoryCreateValidator : AbstractValidator<InsuranceStatisticCategoryCreateDTO>
    {
        public InsuranceStatisticCategoryCreateValidator()
        {
