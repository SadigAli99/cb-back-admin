...
namespace CB.Application.Validators.CustomerDocument
{
    public class CustomerDocumentCreateValidator : AbstractValidator<CustomerDocumentCreateDTO>
    {
        public CustomerDocumentCreateValidator()
        {
