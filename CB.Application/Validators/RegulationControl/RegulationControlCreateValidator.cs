...
namespace CB.Application.Validators.RegulationControl
{
    public class RegulationControlCreateValidator : AbstractValidator<RegulationControlCreateDTO>
    {
        public RegulationControlCreateValidator()
        {
            RuleFor(x => x.File)
