...
namespace CB.Application.Validators.OutOfBankNoteMoneySign
{
    public class OutOfBankNoteMoneySignCreateValidator : AbstractValidator<OutOfBankNoteMoneySignCreateDTO>
    {
        public OutOfBankNoteMoneySignCreateValidator()
        {
            RuleFor(x => x.File)
