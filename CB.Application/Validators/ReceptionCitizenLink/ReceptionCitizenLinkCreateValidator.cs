...
{
    public class ReceptionCitizenLinkCreateValidator : AbstractValidator<ReceptionCitizenLinkCreateDTO>
    {
        public ReceptionCitizenLinkCreateValidator(IReceptionCitizenCategoryService receptionCitizenCategoryService)
        {
