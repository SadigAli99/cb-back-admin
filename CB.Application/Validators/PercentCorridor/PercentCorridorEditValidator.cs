...
{
    public class PercentCorridorEditValidator : AbstractValidator<PercentCorridorEditDTO>
    {
        public PercentCorridorEditValidator(IPercentCorridorCategoryService percentCorridorCategoryService)
        {
            RuleFor(x => x.Date)
