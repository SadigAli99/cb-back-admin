...
namespace CB.Application.Validators.NakhchivanBlog
{
    public class NakhchivanBlogCreateValidator : AbstractValidator<NakhchivanBlogCreateDTO>
    {
        public NakhchivanBlogCreateValidator()
        {
