...
namespace CB.Application.Validators.PolicyConcept
{
    public class PolicyConceptCreateValidator : AbstractValidator<PolicyConceptCreateDTO>
    {
        public PolicyConceptCreateValidator()
        {
            RuleFor(x => x.File)
