...
{
    public class DirectorDetailCreateValidator : AbstractValidator<DirectorDetailCreateDTO>
    {
        public DirectorDetailCreateValidator(IDirectorService directorService)
        {
