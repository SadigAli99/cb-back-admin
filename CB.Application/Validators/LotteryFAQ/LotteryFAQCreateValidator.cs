...
namespace CB.Application.Validators.LotteryFAQ
{
    public class LotteryFAQCreateValidator : AbstractValidator<LotteryFAQCreateDTO>
    {
        public LotteryFAQCreateValidator()
        {
