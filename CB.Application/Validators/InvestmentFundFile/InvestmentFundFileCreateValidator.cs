...
namespace CB.Application.Validators.InvestmentFundFile
{
    public class InvestmentFundFileCreateValidator : AbstractValidator<InvestmentFundFileCreateDTO>
    {
        public InvestmentFundFileCreateValidator()
        {
            RuleFor(x => x.File)
