...
namespace CB.Application.Validators.InternationalEvent
{
    public class InternationalEventCreateValidator : AbstractValidator<InternationalEventCreateDTO>
    {
        public InternationalEventCreateValidator()
        {
