...
namespace CB.Application.Validators.PaymentSystemStandartFAQ
{
    public class PaymentSystemStandartFAQCreateValidator : AbstractValidator<PaymentSystemStandartFAQCreateDTO>
    {
        public PaymentSystemStandartFAQCreateValidator()
        {
