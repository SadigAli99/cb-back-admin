...
namespace CB.Application.Validators.FinancialSearchSystemCaption
{
    public class FinancialSearchSystemCaptionValidator : AbstractValidator<FinancialSearchSystemCaptionPostDTO>
    {
        public FinancialSearchSystemCaptionValidator()
        {
