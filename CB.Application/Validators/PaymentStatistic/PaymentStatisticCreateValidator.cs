...
namespace CB.Application.Validators.PaymentStatistic
{
    public class PaymentStatisticCreateValidator : AbstractValidator<PaymentStatisticCreateDTO>
    {
        public PaymentStatisticCreateValidator()
        {
            RuleFor(x => x.File)
