...
{
    public class ParticipantEditValidator : AbstractValidator<ParticipantEditDTO>
    {
        public ParticipantEditValidator(IParticipantCategoryService participantCategoryService)
        {
