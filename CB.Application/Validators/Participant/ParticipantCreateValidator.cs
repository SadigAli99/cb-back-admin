...
namespace CB.Application.Validators.Participant
{
    public class ParticipantCreateValidator : AbstractValidator<ParticipantCreateDTO>
    {
        public ParticipantCreateValidator(IParticipantCategoryService participantCategoryService)
        {
            ...
            RuleFor(x => x.ParticipantCategoryId)
