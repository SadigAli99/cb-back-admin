...
namespace CB.Application.Validators.AnnualReport
{
    public class AnnualReportCreateValidator : AbstractValidator<AnnualReportCreateDTO>
    {
        public AnnualReportCreateValidator()
        {
            RuleFor(x => x.File)
