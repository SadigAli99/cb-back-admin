...
namespace CB.Application.Validators.InsurerRight
{
    public class InsurerRightCreateValidator : AbstractValidator<InsurerRightCreateDTO>
    {
        public InsurerRightCreateValidator()
        {
            RuleFor(x => x.File)
