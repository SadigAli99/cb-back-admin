...
namespace CB.Application.Validators.VirtualEducation
{
    public class VirtualEducationCreateValidator : AbstractValidator<VirtualEducationCreateDTO>
    {
        public VirtualEducationCreateValidator()
        {
