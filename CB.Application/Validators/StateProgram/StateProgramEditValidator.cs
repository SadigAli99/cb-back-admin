...
{
    public class StateProgramEditValidator : AbstractValidator<StateProgramEditDTO>
    {
        public StateProgramEditValidator(IStateProgramCategoryService participantCategoryService)
        {
