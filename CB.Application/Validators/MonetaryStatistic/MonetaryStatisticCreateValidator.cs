...
namespace CB.Application.Validators.MonetaryStatistic
{
    public class MonetaryStatisticCreateValidator : AbstractValidator<MonetaryStatisticCreateDTO>
    {
        public MonetaryStatisticCreateValidator()
        {
            RuleFor(x => x.File)
