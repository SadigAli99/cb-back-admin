...
{
    public class DigitalPaymentInfograhicCreateValidator : AbstractValidator<DigitalPaymentInfograhicCreateDTO>
    {
        public DigitalPaymentInfograhicCreateValidator(
