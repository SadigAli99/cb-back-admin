...
{
    public class OutOfCoinMoneySignCharacteristicImageEditValidator : AbstractValidator<OutOfCoinMoneySignCharacteristicImageEditDTO>
    {
        public OutOfCoinMoneySignCharacteristicImageEditValidator(IOutOfCoinMoneySignHistoryService moneySignHistoryService)
        {
