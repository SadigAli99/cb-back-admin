...
namespace CB.Application.Validators.OutOfCoinMoneySignCharacteristicImage
{
    public class OutOfCoinMoneySignCharacteristicImageCreateValidator : AbstractValidator<OutOfCoinMoneySignCharacteristicImageCreateDTO>
    {
        public OutOfCoinMoneySignCharacteristicImageCreateValidator(IOutOfCoinMoneySignHistoryService moneySignHistoryService)
        {
