...
namespace CB.Application.Validators.InsurerLaw
{
    public class InsurerLawCreateValidator : AbstractValidator<InsurerLawCreateDTO>
    {
        public InsurerLawCreateValidator()
        {
            RuleFor(x => x.File)
