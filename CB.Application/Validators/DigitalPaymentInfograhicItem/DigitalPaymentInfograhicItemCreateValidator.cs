...
{
    public class DigitalPaymentInfograhicItemCreateValidator : AbstractValidator<DigitalPaymentInfograhicItemCreateDTO>
    {
        public DigitalPaymentInfograhicItemCreateValidator(
