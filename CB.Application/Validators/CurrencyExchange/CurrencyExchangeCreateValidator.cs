...
namespace CB.Application.Validators.CurrencyExchange
{
    public class CurrencyExchangeCreateValidator : AbstractValidator<CurrencyExchangeCreateDTO>
    {
        public CurrencyExchangeCreateValidator()
        {
            RuleFor(x => x.File)
