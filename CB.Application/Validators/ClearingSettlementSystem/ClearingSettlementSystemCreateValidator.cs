...
{
    public class ClearingSettlementSystemCreateValidator : AbstractValidator<ClearingSettlementSystemCreateDTO>
    {
        public ClearingSettlementSystemCreateValidator()
        {
