...
namespace CB.Application.Validators.InstantPaymentFAQ
{
    public class InstantPaymentFAQCreateValidator : AbstractValidator<InstantPaymentFAQCreateDTO>
    {
        public InstantPaymentFAQCreateValidator()
        {
