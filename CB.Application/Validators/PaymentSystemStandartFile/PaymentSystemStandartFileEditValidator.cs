...
{
    public class PaymentSystemStandartFileEditValidator : AbstractValidator<PaymentSystemStandartFileEditDTO>
    {
        public PaymentSystemStandartFileEditValidator(IPaymentSystemStandartService paymentSystemStandartService)
        {
