...
namespace CB.Application.Validators.CapitalMarketLaw
{
    public class CapitalMarketLawCreateValidator : AbstractValidator<CapitalMarketLawCreateDTO>
    {
        public CapitalMarketLawCreateValidator()
        {
            RuleFor(x => x.File)
