...
namespace CB.Application.Validators.CapitalMarketRight
{
    public class CapitalMarketRightCreateValidator : AbstractValidator<CapitalMarketRightCreateDTO>
    {
        public CapitalMarketRightCreateValidator()
        {
            RuleFor(x => x.File)
