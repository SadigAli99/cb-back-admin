...
namespace CB.Application.Validators.PaymentService
{
    public class PaymentServiceCreateValidator : AbstractValidator<PaymentServiceCreateDTO>
    {
        public PaymentServiceCreateValidator()
        {
            RuleFor(x => x.File)
