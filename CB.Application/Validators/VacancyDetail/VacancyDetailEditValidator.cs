...
{
    public class VacancyDetailEditValidator : AbstractValidator<VacancyDetailEditDTO>
    {
        public VacancyDetailEditValidator(IVacancyService vacancyService)
        {
            RuleFor(x => x.VacancyId)
                    .NotNull().WithMessage("Vakansiya şəxsi seçin")
