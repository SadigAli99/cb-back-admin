...
namespace CB.Application.Validators.InsuranceBroker
{
    public class InsuranceBrokerCreateValidator : AbstractValidator<InsuranceBrokerCreateDTO>
    {
        public InsuranceBrokerCreateValidator()
        {
            RuleFor(x => x.File)
