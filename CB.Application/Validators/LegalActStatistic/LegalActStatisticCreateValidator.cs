...
namespace CB.Application.Validators.LegalActStatistic
{
    public class LegalActStatisticCreateValidator : AbstractValidator<LegalActStatisticCreateDTO>
    {
        public LegalActStatisticCreateValidator()
        {
            RuleFor(x => x.File)
