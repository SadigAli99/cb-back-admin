...
namespace CB.Application.Validators.StockExchange
{
    public class StockExchangeCreateValidator : AbstractValidator<StockExchangeCreateDTO>
    {
        public StockExchangeCreateValidator()
        {
