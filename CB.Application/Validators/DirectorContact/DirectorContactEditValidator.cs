...
{
    public class DirectorContactEditValidator : AbstractValidator<DirectorContactEditDTO>
    {
        public DirectorContactEditValidator(IDirectorService directorService)
        {
