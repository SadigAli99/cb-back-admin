...
namespace CB.Application.Validators.DirectorContact
{
    public class DirectorContactCreateValidator : AbstractValidator<DirectorContactCreateDTO>
    {
        public DirectorContactCreateValidator(IDirectorService directorService)
        {
