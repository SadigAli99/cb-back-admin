...
namespace CB.Application.Validators.OtherPresidentAct
{
    public class OtherPresidentActCreateValidator : AbstractValidator<OtherPresidentActCreateDTO>
    {
        public OtherPresidentActCreateValidator()
        {
            RuleFor(x => x.File)
