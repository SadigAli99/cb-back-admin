...
{
    public class CitizenApplicationEditValidator : AbstractValidator<CitizenApplicationEditDTO>
    {
        public CitizenApplicationEditValidator(ICitizenApplicationCategoryService citizenApplicationCategoryService)
        {
            RuleFor(x => x.Month)
