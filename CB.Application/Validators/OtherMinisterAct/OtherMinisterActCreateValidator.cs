...
namespace CB.Application.Validators.OtherMinisterAct
{
    public class OtherMinisterActCreateValidator : AbstractValidator<OtherMinisterActCreateDTO>
    {
        public OtherMinisterActCreateValidator()
        {
            RuleFor(x => x.File)
