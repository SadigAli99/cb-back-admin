...
namespace CB.Application.Validators.CreditInstitutionPresidentAct
{
    public class CreditInstitutionPresidentActCreateValidator : AbstractValidator<CreditInstitutionPresidentActCreateDTO>
    {
        public CreditInstitutionPresidentActCreateValidator()
        {
            RuleFor(x => x.File)
