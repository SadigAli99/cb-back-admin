...
{
    public class CreditInstitutionPresidentActEditValidator : AbstractValidator<CreditInstitutionPresidentActEditDTO>
    {
        public CreditInstitutionPresidentActEditValidator()
        {
            RuleFor(x => x.File)
