...
{
    public class MembershipInternationalOrganizationEditValidator : AbstractValidator<MembershipInternationalOrganizationEditDTO>
    {
        public MembershipInternationalOrganizationEditValidator()
        {
            RuleFor(x => x.Month)
