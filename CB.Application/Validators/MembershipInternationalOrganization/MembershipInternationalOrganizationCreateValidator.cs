...
namespace CB.Application.Validators.MembershipInternationalOrganization
{
    public class MembershipInternationalOrganizationCreateValidator : AbstractValidator<MembershipInternationalOrganizationCreateDTO>
    {
        public MembershipInternationalOrganizationCreateValidator()
        {
            RuleFor(x => x.Month)
