...
{
    public class MacroprudentialPolicyFrameworkEditValidator : AbstractValidator<MacroprudentialPolicyFrameworkEditDTO>
    {
        public MacroprudentialPolicyFrameworkEditValidator()
        {
            RuleFor(x => x.File)
