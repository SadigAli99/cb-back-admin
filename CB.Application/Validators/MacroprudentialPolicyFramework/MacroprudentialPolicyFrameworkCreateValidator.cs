...
namespace CB.Application.Validators.MacroprudentialPolicyFramework
{
    public class MacroprudentialPolicyFrameworkCreateValidator : AbstractValidator<MacroprudentialPolicyFrameworkCreateDTO>
    {
        public MacroprudentialPolicyFrameworkCreateValidator()
        {
            RuleFor(x => x.File)
