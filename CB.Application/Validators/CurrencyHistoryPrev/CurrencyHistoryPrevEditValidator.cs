...
{
    public class CurrencyHistoryPrevEditValidator : AbstractValidator<CurrencyHistoryPrevEditDTO>
    {
        public CurrencyHistoryPrevEditValidator(ICurrencyHistoryService currencyHistoryService)
        {
