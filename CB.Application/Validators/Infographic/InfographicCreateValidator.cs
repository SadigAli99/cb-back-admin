...
namespace CB.Application.Validators.Infographic
{
    public class InfographicCreateValidator : AbstractValidator<InfographicCreateDTO>
    {
        public InfographicCreateValidator()
        {
            RuleFor(x => x.Month)
