...
namespace CB.Application.Validators.NationalBankNoteMoneySign
{
    public class NationalBankNoteMoneySignEditValidator : AbstractValidator<NationalBankNoteMoneySignEditDTO>
    {
        public NationalBankNoteMoneySignEditValidator()
        {
            RuleFor(x => x.File)
