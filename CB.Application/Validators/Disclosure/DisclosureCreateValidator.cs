...
namespace CB.Application.Validators.Disclosure
{
    public class DisclosureCreateValidator : AbstractValidator<DisclosureCreateDTO>
    {
        public DisclosureCreateValidator()
        {
            RuleFor(x => x.File)
